...
export const heroSlides = [
  {
    ...
    subtitle: "Obtenha as melhores taxas, desbloqueie benefícios exclusivos e ganhe pontos resgatáveis",
    cta: "Reserve Mesa",
    ctaLink: "#",
    bgGradient: "linear-gradient(170deg, #2a1510 0%, #1a1210 30%, #181412 60%, #121212 100%)",
    image: "/images/hero-1.jpg",
  },
  {
    id: 2,
    title: "Poker em\nGrande Estilo",
    subtitle: "24 horas por dia, 7 dias por semana. Dealers treinados e ambiente sofisticado.",
    cta: "Reserve Mesa",
    ctaLink: "#",
    bgGradient: "linear-gradient(170deg, #15101a 0%, #0d1520 30%, #1a1510 60%, #121212 100%)",
    image: "/images/hero-2.jpg",
  },
  {
    id: 3,
    title: "Alta Gastronomia\n& Entretenimento",
    subtitle: "Sabores de diversas partes do mundo em um ambiente único e sofisticado.",
    cta: "Reserve Mesa",
    ctaLink: "#",
    bgGradient: "linear-gradient(170deg, #1a1015 0%, #150d10 30%, #10150d 60%, #121212 100%)",
